...
public class WrapperObjectsFixture extends FixtureScript {
    ...
    private final List<WrapperObject> objects = Lists.newArrayList();

    public List<WrapperObject> getObjects() {
        return objects;
    }
    //endregion
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        for (int k = 0; k < getNumberToCreate(); k++) {
            ...
            final WrapperObject object =
                    wrapperObjects.createWrapperObject(str, b, s, i, l, f, d);
